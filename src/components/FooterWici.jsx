...
const FooterWici = () => {
  ...
  const texts = {
    es: {
      ...
      contacto: "Contacto",
      contactoTexto: "Para más información, escribir a"
    },
    en: {
      colaboradores: "Collaborators",
      contacto: "Contact",
      contactoTexto: "For more information, write to"
    }
  };
  ...
  return (
    <footer id="contacto" className="bg-[#010d1f]">
      {/* Sección de sponsors */}
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        <div>
          <div>
            <h2 className="mx-auto mt-2 max-w-md text-center leading-relaxed text-3xl text-[#e0b02e]">
              {t.contacto}
            </h2>
          </div>
          <div>
            <p className="mx-auto mt-2 max-w-md text-center leading-relaxed text-gray-300">
              {t.contactoTexto}{' '}
              <a href="mailto:wici.ve@utp.ac.pa" className="text-[#e0b02e] hover:text-[#c99a1f] transition font-medium">
                wici.ve@utp.ac.pa
              </a>
            </p>
          </div>
        ...
        <ul className="mt-6 flex justify-center gap-6 md:gap-8">
          <li>
            <a
              href="https://www.facebook.com/congreso.ve/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-[#e0b02e] dark:text-white dark:hover:text-[#e0b02e]"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/coicit_utpveraguas/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-[#e0b02e] dark:text-white dark:hover:text-[#e0b02e]"
            >
